...
Dann legen wir mal los. Startet die Godot Engine. Ihr solltet nach einer kurzen Ladezeit folgendes Fenster sehen:
...
!!! info "Spracheinstellung"
    Falls die Projektverwaltung auf Englisch angezeigt ist, könnt ihr sie - und damit das gesamte Programm - oben rechts auf Deutsch umstellen. Das hilft teilweise am Anfang überall die richtigen Einstellungen zu finden, aber wenn ihr mal online nach Hilfe fragt, werdet ihr immer die Englischen Begriffe finden. Ein Umstellen ist auch jederzeit in den Programmeinstellungen möglich.
...
Du musst einen leeren Ordner finden, in dem ihr die Dateien ablegen wollt. Unter Umständen musst du diesen neu anlegen. Am Ende sollte es in der Projektverwaltung wie im folgenden Bild aussehen. Achte dabei auf den grünen Haken, der taucht nur auf, wenn der Pfad auf einen leeren Ordner zeigt:
